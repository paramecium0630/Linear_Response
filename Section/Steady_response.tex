...
\end{equation}
This is the general steady-state linear response formula used throughout this work \cite{softmatter}. Importantly, it does not require equilibrium. Instead, it only requires that the system fluctuates around a steady state. In the following sections, we apply this general framework to parameter changes in the intrinsic node parameter $r_\alpha$, the connection weight $W_{\alpha\beta}$, and the noise strength $\sigma_{\alpha\alpha}$.
