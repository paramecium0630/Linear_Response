...
\begin{equation}
    \delta \vec{x}(t+\tau) = e^{\tau \mathbf{Q}} \delta \vec{x}(t) + \int_t^{t+\tau} ds e^{(t+\tau+s)Q} \vec{\eta}(s),
\end{equation}
