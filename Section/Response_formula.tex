...
\quad We first consider the perturbation of a single node perturbation $r_\alpha$, where $\alpha$ denotes the index of the perturbed node. One obtains the steady-state response of the equal-time covariance matrix
\begin{equation}
