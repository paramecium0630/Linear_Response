...
\begin{figure}[H]
    \centering
    \subfigure[]{\includegraphics*[width=.45\columnwidth]{Figure/Multiple/MultipledKdWii_non.eps}}
    \subfigure[]{\includegraphics*[width=.44\columnwidth]{Figure/Multiple/MultipledKdWij_non.eps}}
    \caption{The }
    \label{MultipledKdW} 
\end{figure}
